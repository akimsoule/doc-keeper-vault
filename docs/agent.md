# Prompt GitHub Copilot – Dashboard mobile-first sécurisé avec UX améliorée et cac## Optimisation – Cache API
...
├── contexts/         # Contextes React (auth, cache)
├── hooks/            # Hooks personnalisés
├── pages/            # Pages principales
├── services/         # Services API
├── types/            # Types TypeScript
└── utils/            # Utilitaires
```re un dashboard pour mon application avec **Vite + React + TypeScript** et **DaisyUI**.  
...
1. **Installation de Tailwind CSS et daisyUI**
   ```bash
...
3. **Configuration CSS** (`src/style.css`)
   ```css
   @import "tailwindcss";
   @plugin "daisyui";
   ```
