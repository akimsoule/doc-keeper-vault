...
# Générer une clé de chiffrement MEGA
echo ""
echo "2. Clé de chiffrement MEGA (à ajouter dans MEGA_ENCRYPTION_KEY):"
openssl rand -hex 32
...
echo "4. Pour la production, utilisez MEGA_ENCRYPTION_KEY au lieu d'ENCRYPTION_KEY"
echo ""
echo "⚠️  IMPORTANT: Gardez ces secrets en sécurité et ne les partagez jamais!"
echo "⚠️  NOTE: Chaque utilisateur configurera ses propres credentials MEGA dans l'interface d'administration"
